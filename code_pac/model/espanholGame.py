...
import GameQualityAssessment.code_pac.espanhol.model.game as ESmodel

class LaLigaGame(GenericGame):
    def __init__(self, game):
        if not isinstance(game, ESmodel.Game):
            raise TypeError('Arg must to be a brasileiro.model.Game instance')
        self._winner = None
        super(LaLigaGame, self).__init__(game)
